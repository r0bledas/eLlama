...
1. **Windows Installer ([`eLlama-Setup-v1.2.0.exe`](https://github.com/r0bledas/eLlama/releases/latest))**:
...
2. **Portable Edition ([`eLlama-Portable-v1.2.0-win-x64.zip`](https://github.com/r0bledas/eLlama/releases/latest))**:
